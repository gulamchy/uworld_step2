  ...
  return (
    <div style={{ backgroundColor: "#F3F3F4" }}>
      ...
      <div className="mx-[16px]">
        <div className="flex items-center  font-[Open_Sans] text-xl">
          <div className="px-[24px] py-[12px]  text-[#8A8B92]">
            Shelf Review
          </div>
        ...
        <div className="min-h-screen bg-white">
          ...
          <table className="w-full justtable-auto text-sm ">
            <thead>
            ...
            <tbody>
              {files.map((file, idx) => (
                ...
                >
                  ...
                  <td className="px-[32px] py-[20px] text-left font-normal w-[184px]">
                    {file.testMode == 'Timed'? 'Untutored, Timed': 'Tutored, Untimed'}
                  </td>
